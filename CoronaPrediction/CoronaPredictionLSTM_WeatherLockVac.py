...
from DataCleaning import cleanDataFramForAustria, cleanDataFramWithoutAustria, addWeatherInformation, addWeatherInformation_Val, addVaccination, addLockdownInformationForAustria
...
selection = ["Time","BundeslandID", "AnzahlPlus10d", "AnzahlFaelle", "SiebenTageInzidenzFaelle","Temperature","Relative Humidity","Precipitation", "Wind Speed", "VacDose2", "VacDose3", "LockDown" ]
df = df[selection]
dfValTest = dfValTest[selection]
folder = "../Output/WeatherLockVac_LastDays/3/"
