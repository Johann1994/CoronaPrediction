...
from DataCleaning import cleanDataFramForAustria, cleanDataFramWithoutAustria, addVaccination, addLockdownInformationForAustria
...
selection = ["Time","BundeslandID", "AnzahlPlus10d", "AnzahlFaelle", "SiebenTageInzidenzFaelle","VacDose2", "VacDose3", "LockDown" ]
df = df[selection]
dfValTest = dfValTest[selection]
folder = "../Output/LockDownAndVaccination_LastDays/3/"
