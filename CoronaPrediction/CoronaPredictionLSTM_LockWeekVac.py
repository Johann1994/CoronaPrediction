...
from DataCleaning import cleanDataFramForAustria, cleanDataFramWithoutAustria, addVaccination, addVaccination, addWeekDays, addLockdownInformationForAustria
...
selection = ["Time","BundeslandID", "AnzahlPlus10d", "AnzahlFaelle", "SiebenTageInzidenzFaelle","VacDose2", "VacDose3", "LockDown", "weekDay" ]
df = df[selection]
dfValTest = dfValTest[selection]
folder = "../Output/LockVacWeek_LastDays/3/"
