...
from DataCleaning import cleanDataFramForAustria, cleanDataFramWithoutAustria, addWeatherInformation, addWeekDays
...
selection = ["Time","BundeslandID", "AnzahlPlus10d", "AnzahlFaelle", "SiebenTageInzidenzFaelle","weekDay" ]
df = df[selection]
dfValTest = dfValTest[selection]
folder = "../Output/WeekDayLastDay/2/"
