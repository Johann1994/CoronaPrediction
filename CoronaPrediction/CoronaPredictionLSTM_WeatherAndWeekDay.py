...
from DataCleaning import cleanDataFramForAustria, cleanDataFramWithoutAustria, addWeatherInformation, addWeatherInformation_Val, addWeekDays
...
selection = ["Time","BundeslandID", "AnzahlPlus10d", "AnzahlFaelle", "SiebenTageInzidenzFaelle","Temperature","Relative Humidity","Precipitation", "Wind Speed", "weekDay" ]
df = df[selection]
dfValTest = dfValTest[selection]
folder = "../Output/WeatherAndWeekDays_LastDays/3/"
