...
from DataCleaning import cleanDataFramForAustria, cleanDataFramWithoutAustria, addWeatherInformation, addWeatherInformation_Val, addVaccination
...
selection = ["Time","BundeslandID", "AnzahlPlus10d", "AnzahlFaelle", "SiebenTageInzidenzFaelle","Temperature","Relative Humidity","Precipitation", "Wind Speed", "VacDose2", "VacDose3" ]
df = df[selection]
dfValTest = dfValTest[selection]
folder = "../Output/WeatherAndVac_LastDays/3/"
